...
1. The default number of epochs was changed from `1000` to `500` per AECCT
   phase. AECCT still has two phases: 500 normal-training epochs followed by
   500 quantization-aware-training epochs.
